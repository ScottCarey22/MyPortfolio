...
SECRET_KEY = os.environ.get('SECRET_KEY', default = "da99d16341f347cce5df059e830808f9")
...
# Password validation
# https://docs.djangoproject.com/en/5.0/ref/settings/python#auth-password-validators
